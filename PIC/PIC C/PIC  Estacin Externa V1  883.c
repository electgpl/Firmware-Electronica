...
static int8 lecturaLDR(void){                                  //Funcion que realiza la lectura del ADC para el LDR
   ...
   return((3*read_adc()-147)/10);                              //Retorna el valor del ADC canal 0
}
//*********************************************************************************************************
...
void enivaRF(void){                                            //Declaración de función para enviar datos
   ...
   payload[4]=payload[1]+payload[2]+payload[3];                //Realiza suma de los datos y lo carga en el byte 4 del payload
